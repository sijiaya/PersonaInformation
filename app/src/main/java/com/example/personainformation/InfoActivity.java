...
public class InfoActivity extends AppCompatActivity implements View.OnClickListener{
        ...
        etRealname.setOnKeyListener(new View.OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ...
                if (keyCode == KeyEvent.KEYCODE_ENTER && event.getAction() == KeyEvent.ACTION_UP) {
                    //关闭软键盘
                    InputMethodManager imm = (InputMethodManager) InfoActivity.this.getSystemService(Context.INPUT_METHOD_SERVICE);
    ...
    private void getInfo() {
        ...
        //2.显示内容
        String  info = "用户名："+username+"\n姓名："+realname+"\n性别："+favorite.trim().substring(0,favorite.trim().length()-1);
